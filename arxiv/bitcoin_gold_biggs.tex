...
\begin{itemize}
    ...
    \item Live model scorecard with periodic updates (\url{https://github.com/silmonbiggs/BTCvGold/blob/master/SCORECARD.md})
\end{itemize}
